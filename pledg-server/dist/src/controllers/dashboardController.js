...
exports.getLenderTransactionsByLoanId = exports.getLenderTransactions = exports.getBorrowerTransactionsByLoanId = exports.getBorrowerTransactions = exports.getDashboardOverview = void 0;
...
const getBorrowerTransactions = (_req, res) => {
    res.status(501).json({ message: 'Get borrower transactions endpoint - not implemented' });
};
exports.getBorrowerTransactions = getBorrowerTransactions;
const getBorrowerTransactionsByLoanId = (_req, res) => {
    res.status(501).json({ message: 'Get borrower transactions by loan ID endpoint - not implemented' });
};
exports.getBorrowerTransactionsByLoanId = getBorrowerTransactionsByLoanId;
const getLenderTransactions = (_req, res) => {
...
const getLenderTransactionsByLoanId = (_req, res) => {
    res.status(501).json({ message: 'Get lender transactions by loan ID endpoint - not implemented' });
};
exports.getLenderTransactionsByLoanId = getLenderTransactionsByLoanId;
